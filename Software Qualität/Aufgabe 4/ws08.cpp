...
class Behaelter
{
	public:
		...
		virtual const Person* getNext(void) = 0; //Unklar: Steht der Zeiger anf�nglich VOR dem ersten Element?
};
...
//Inkonsitzenz in den Spezifikation: Laut A3: "Die Funktion remove() entfernt eine Person aus dem Beh�lter und gibt sie als R�ckgabewert zur�ck."
...
class Stack : public Behaelter
{
	...
	public:
		...
		const Person* getNext(void) { return PersonStack[++pos]; } //Segmention Fault bei falscher Nutzung. �berpr�fung von hasNext()?
};
